...
candidate = diagnostic_candidate_by_run(os.environ["G1_RQ14_LESION_RUN"])
source_run = os.environ.get("G1_RQ15_SOURCE_RUN")
if source_run is None:
    raise ValueError("RQ14 lesion run requires G1_RQ15_SOURCE_RUN")
...
overrides = {
    ...
    "dataloader": replace(
        base.dataloader, batch_size=candidate.batch_size, gradient_accumulation_steps=1
    ),
